    ...
    <CAPTION><h3>SPECIAL DEALS</h3></CAPTION>
        ...
        <?php
                ...
                while ($row=mysqli_fetch_assoc($result)){
                    echo "<tr>";
                    echo '<td><a href=images/'. $row['special_photo']. ' alt="click to view full image" target="_blank"><img src=images/special.png'. $row['special_photo']. ' width="80" height="70"></a></td>';
